...
| **コストモデル**        | エンドポイント毎のコスト（1〜100ユニット）                      | 定額（1リクエスト = 1トークン）                     | 定額（1リクエスト = 1トークン）                         |
...
| :---------------------------------- | :-----: | :----: | :---------: |
| URL からコンテンツ取得              |  対応   |  対応  |    対応     |
| ID からコンテンツ取得               |  対応   |  対応  |    対応     |
| ライブ配信一覧                      |  対応   |  対応  |    対応     |
| アーカイブ一覧（ページネーション）  |  対応   |  対応  |    対応     |
| チャンネル情報取得                  |  対応   |  対応  |    対応     |
| アーカイブ解決                      |  対応   |  対応  |    対応     |
| 検索                                |  対応   |  対応  |    対応     |
| クリップ                            | 非対応  |  対応  |   非対応    |
...
| チャンネル一括取得                  |  対応   | 対応\* |   対応\*    |
| クリップ一括取得                    | 非対応  |  対応  |   非対応    |
| クロスプラットフォーム配信取得      |  対応   |  対応  |    対応     |
| クロスプラットフォーム検索          |  対応   |  対応  |    対応     |
| OpenTelemetry トレース & メトリクス |  対応   |  対応  |    対応     |

\* バッチAPIがないプラットフォームでは、1件ずつリクエストして同等の結果を返します
