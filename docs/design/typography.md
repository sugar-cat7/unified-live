...
Choose a font with high readability that is comfortable for long-form reading.
...
Choose a font that expresses your brand's personality. Create contrast with the body font for visual distinction.
...
Prepare at minimum the following weights:
...
- Setting line height below 1.4 (for text readability)
