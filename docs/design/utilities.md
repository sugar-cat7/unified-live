...
**Use case**: Headings, catchphrases, and other short text

### text-2xs / text-3xs

Text sizes smaller than Tailwind standard.

| Class | Size | Line Height | Usage |
|-------|------|-------------|-------|
| `text-2xs` | 0.7rem (11.2px) | 1rem | Small labels, supplementary information |
...
**Use case**: Modal, tooltip display
...
Surfaces for information and alert display.
...
Dedicated classes for video overlay use.
...
**Use case**: Timestamps and status display on videos
...
| `min-w-pricing-table` | 600px | Minimum width for pricing table |
