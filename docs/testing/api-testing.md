...
3. Cover input variations comprehensively with table-driven tests
...
- Exception: only replace external API calls at the boundary

## Contract Testing

- API cases: Vitest + Hono testClient
- OpenAPI contract: validate `/doc` with Schemathesis or similar tools
