...
- Platform API credentials (see [Platform Plugins](./03-platform-plugins.md))

## Next Steps

- [Core Concepts](./02-core-concepts.md) — Content, Channel, and type system
- [Platform Plugins](./03-platform-plugins.md) — Configuration for each platform
- [Error Handling](./04-error-handling.md) — Handling API errors gracefully
